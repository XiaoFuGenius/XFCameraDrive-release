...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [XFPromptWindow InitPromptWindow:UIWindowLevelStatusBar+1];
    [XFLoadingWindow InitLoadingWindow:UIWindowLevelStatusBar];

    UIViewController *ctr = [NSClassFromString(@"XFIndexViewController") new];
